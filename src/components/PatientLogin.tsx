...
export default function PatientLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check if user has patient role or no role (default to patient)
      ...
      if (roleData && roleData.role !== 'patient') {
        await supabase.auth.signOut();
        throw new Error('Access denied. Please use the doctor login portal.');
      }

      // If no role exists, create patient role
      if (!roleData) {
      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Patient Login</h2>
        ...
        <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <p className="text-sm text-blue-800 dark:text-blue-200">
            <strong>For Patients:</strong> Track your health, book appointments, manage medications, and consult with doctors online.
          </p>
        </div>
      </div>
    </div>
